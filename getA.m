function A = getA(IP1,IP2,x1,x2,y1,y2,X,Y,Z,R1,R2,f1,f2,drw1,drw2,drp1,drp2,drk1,drk2)
	...
	for m=1:n
		...
		A(a-2,8) = x2(m)*( drw2(3,1)*(X(m)-IP2(1)) + drw2(3,2)*(Y(m)-IP1(2)) + drw2(3,3)*(Z(m)-IP1(3)) ) + f2*( drw2(1,1)*(X(m)-IP2(1)) + drw2(1,2)*(Y(m)-IP1(2)) + drw2(1,3)*(Z(m)-IP1(3)) ); % dw2
		...
		A(a-2,10) = x2(m)*( drp2(3,1)*(X(m)-IP2(1)) + drp2(3,2)*(Y(m)-IP1(2)) + drp2(3,3)*(Z(m)-IP1(3)) ) + f1*( drp2(1,1)*(X(m)-IP2(1)) + drp2(1,2)*(Y(m)-IP1(2)) + drp2(1,3)*(Z(m)-IP1(3)) ); % dp2
		...
		A(a-2,12) = x2(m)*( drk2(3,1)*(X(m)-IP2(1)) + drk2(3,2)*(Y(m)-IP1(2)) + drk2(3,3)*(Z(m)-IP1(3)) ) + f2*( drk2(1,1)*(X(m)-IP2(1)) + drk2(1,2)*(Y(m)-IP1(2)) + drk2(1,3)*(Z(m)-IP1(3)) ); % dk2
		...
		A(a,8) = y2(m)*( drw2(3,1)*(X(m)-IP2(1)) + drw2(3,2)*(Y(m)-IP1(2)) + drw2(3,3)*(Z(m)-IP1(3)) ) + f2*( drw2(2,1)*(X(m)-IP2(1)) + drw2(2,2)*(Y(m)-IP1(2)) + drw2(2,3)*(Z(m)-IP1(3)) ); % dw2
		...
		A(a,10) = y2(m)*( drp2(3,1)*(X(m)-IP2(1)) + drp2(3,2)*(Y(m)-IP1(2)) + drp2(3,3)*(Z(m)-IP1(3)) ) + f1*( drp2(2,1)*(X(m)-IP2(1)) + drp2(2,2)*(Y(m)-IP1(2)) + drp2(2,3)*(Z(m)-IP1(3)) ); % dp2
		...
		A(a,12) = y2(m)*( drk2(3,1)*(X(m)-IP2(1)) + drk2(3,2)*(Y(m)-IP1(2)) + drk2(3,3)*(Z(m)-IP1(3)) ) + f2*( drk2(2,1)*(X(m)-IP2(1)) + drk2(2,2)*(Y(m)-IP1(2)) + drk2(2,3)*(Z(m)-IP1(3)) ); % dk2
